...
app.get("/cart", (req, res) => {
    res.render("shoppingcart", { shoppingCart: req.session.shoppingCart, cartSize: getCartSize(req) });
});


function getCartSize(req) {
    return req.session.shoppingCart !== undefined ? req.session.shoppingCart.length : 0;
}
